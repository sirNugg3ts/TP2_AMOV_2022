...
class _EmentaScreenState extends State<EmentaScreen> {
  ...
  Future<void> _fetchCantinaEmentas() async {
    ...
    if (token != null) {
      ...
      try {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Não existe uma versão local de cache, a obter do servidor...')));

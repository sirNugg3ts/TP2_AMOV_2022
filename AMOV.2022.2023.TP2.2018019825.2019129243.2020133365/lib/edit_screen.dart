...
const String url_menu = 'http://192.168.1.64:8080/menu';
const String url_image = 'http://192.168.1.64:8080/images/';
...
class EditScreen extends StatefulWidget {
  ...
  static const latCantina = 40.1930131024;
  static const altCantina = -8.41198999473;
...
class _EditScreenState extends State<EditScreen> {
  ...
  Future<void> checkIfLocationCorrect() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          backgroundColor: Colors.green, title: const Text("Editar ementa")),
      body: Center(
      ...
      await checkIfLocationCorrect().then((value) => {
            !_canEdit
                ? ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                    content: Text("Tem que estar na cantina para editar!")))
                : null
          });
    });
  }
